...
Цена нехватки `work_mem`: 156 тысяч страниц в режиме lossy, 3 миллиона перепроверенных строк, +200ms времени.
...
```
work_mem ≤ (total_RAM - shared_buffers) / (max_connections * запас_2)
```
